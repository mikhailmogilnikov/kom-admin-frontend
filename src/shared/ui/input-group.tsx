...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: biome does not support this
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: biome does not support this
    // biome-ignore lint/a11y/useSemanticElements: biome does not support this
    // biome-ignore lint/a11y/useKeyWithClickEvents: biome does not support this
    <div
